...
// Update 
$sql = "UPDATE home_page SET title='$title',icon='$icon',header='$header',image='$folder' WHERE home_id='$home_id' ";
...
if (isset($_GET['id'])) {
    ...
    // Retrive data
    $sql = "SELECT * FROM home_page WHERE home_id ='$home_id'";
...
<div class="container card mt-5 px-3">
    <form action="" method="post" id="user_from" enctype="multipart/form-data">
        <input type="hidden" name="home_id" class="from-control" value="<?php echo $row['home_id']; ?>">
        ...
        <div class="form-group">
            ...
            <a href="home.php" class="text-decoration-none btn  btn-outline-primary">View</a>
