                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="home.php">Main Section </a>
                                <a class="nav-link" href="counter.php">Counter</a>
                                <a class="nav-link" href="about.php">About</a>
                                <a class="nav-link" href="r_work.php">Recntly Work Complete</a>
                                <a class="nav-link" href="team.php">Team</a>
                                <a class="nav-link" href="testimonial.php">Testimonial</a>
                                <a class="nav-link" href="blog.php">Blog</a>
                                <a class="nav-link" href="contact_details.php">Contact Details</a>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="choose_service.php">Choose Service</a>
                            </nav>
                        </div>
