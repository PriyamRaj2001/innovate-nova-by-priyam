...
<div class="container">
	<div class="row">
		...
		<!--
			...
			<hr>
			<form id="myForm" method="post" action="home_insert.php" style="display:none;" enctype="multipart/form-data">
				<div class="form-group">
					<label for="title">Title:</label>
					<input type="text" class="form-control" name="title">
				</div>
				<div class="form-group">
					<label for="icon">Icon Class Link:</label>
...
<div class="container-fluid">
	...
	<div class="container p-3  pb-3">
		...
		<a href="home_update.php?id=<?php echo $row['home_id']; ?>" class="text-decoration-none btn  btn-outline-primary">Update</a>
