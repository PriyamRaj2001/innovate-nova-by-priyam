...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<form id="myForm" method="post" action="testimonial_insert.php" style="display:none;" enctype="multipart/form-data">
	...
	<div class="card">
		...
		?>
			...
			<div class="container p-3  pb-3">
				...
				<a href="testimonial_update.php?id=<?php echo $row['testimonial_id']; ?>" class="text-decoration-none btn  btn-outline-primary">Update</a>
		<a href="testimonial_delete.php?id=<?php echo $row['testimonial_id']; ?>" class="text-decoration-none btn  btn-outline-danger">Delete</a>
